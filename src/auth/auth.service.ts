...
export class AuthService {
  ...
  async signin(signinAuthDto: SigninAuthDto): Promise<AuthResponse> {
    ...
    const pwMatches = await argon.verify(user.hash, signinAuthDto.password);
  ...
  async signToken(userId: number, email: string): Promise<AuthResponse> {
